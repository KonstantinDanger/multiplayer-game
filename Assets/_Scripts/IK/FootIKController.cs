...
public class FootIKController : MonoBehaviour
{
    ...
    //        [HideInInspector] public Quaternion currentRot;
    //        [HideInInspector] public bool initialized;
    //    }

    //    [Header("Legs")]
    //    public FootData[] feet = new FootData[]
    //    {
    //        new FootData { goal = AvatarIKGoal.LeftFoot  },
    //        new FootData { goal = AvatarIKGoal.RightFoot }
    //    };
    ...
    //    [Header("Smoothing")]
    //    [Range(1f, 30f)] public float positionSpeed = 10f;
    ...
    //    void ProcessFoot(FootData foot)
    //    {
    //        // Get the foot position that the animator computed this frame
    //        Vector3 animPos = _anim.GetIKPosition(foot.goal);
    //        Vector3 origin = animPos + Vector3.up * rayOriginOffset;

    //        if (Physics.Raycast(origin, Vector3.down, out RaycastHit hit,
    //                            rayOriginOffset + rayLength, groundMask))
    //        {
    //            if (!foot.initialized)
    //            {
    //                foot.currentPos = hit.point;
    //                foot.currentRot = Quaternion.LookRotation(
    //                                       _anim.GetIKRotation(foot.goal) * Vector3.forward,
    //                                       hit.normal);
    //                foot.initialized = true;
    //            }

    //            foot.currentPos = Vector3.Lerp(foot.currentPos, hit.point,
    //                                           Time.deltaTime * positionSpeed);

    //            Quaternion goalRot = alignToNormal
    //                ? Quaternion.FromToRotation(Vector3.up, hit.normal)
    //                  * _anim.GetIKRotation(foot.goal)
    //                : _anim.GetIKRotation(foot.goal);

    //            foot.currentRot = Quaternion.Slerp(foot.currentRot, goalRot,
    //                                               Time.deltaTime * rotationSpeed);

    //            foot.currentWeight = Mathf.Lerp(foot.currentWeight, foot.ikWeight,
    //                                            Time.deltaTime * positionSpeed);
    //        }
    //        else
    //        {
    //            foot.currentWeight = Mathf.Lerp(foot.currentWeight, 0f,
    //                                            Time.deltaTime * positionSpeed);
    //        }

    //        _anim.SetIKPositionWeight(foot.goal, foot.currentWeight);
    //        _anim.SetIKRotationWeight(foot.goal, foot.currentWeight);
    //        _anim.SetIKPosition(foot.goal, foot.currentPos);
    //        _anim.SetIKRotation(foot.goal, foot.currentRot);
    //    }
    ...
    //        foreach (var foot in feet)
    //        {
    //            Vector3 origin = _anim.GetIKPosition(foot.goal) + Vector3.up * rayOriginOffset;
    //            Gizmos.color = Color.green;
    //            Gizmos.DrawLine(origin, origin + Vector3.down * (rayOriginOffset + rayLength));
    //        }
    //    }
    //#endif
}
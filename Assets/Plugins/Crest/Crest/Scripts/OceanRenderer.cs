...
#pragma warning restore 414
        ...
        public ITimeProvider TimeProvider => _timeProviderStack[_timeProviderStack.Count - 1];
...
#pragma warning restore 414
        ...
        public static bool RunningWithoutGPU
        {
            get
            {
                ...
                var emulateNoGPU = (Instance != null && Instance._debug._forceNoGPU);
        ...
        static readonly int sp_meshScaleLerp = Shader.PropertyToID("_MeshScaleLerp");
        static readonly int sp_sliceCount = Shader.PropertyToID("_SliceCount");
        static readonly int sp_clipByDefault = Shader.PropertyToID("_CrestClipByDefault");
        static readonly int sp_lodAlphaBlackPointFade = Shader.PropertyToID("_CrestLodAlphaBlackPointFade");
        static readonly int sp_lodAlphaBlackPointWhitePointFade = Shader.PropertyToID("_CrestLodAlphaBlackPointWhitePointFade");
        static readonly int sp_CrestDepthTextureOffset = Shader.PropertyToID("_CrestDepthTextureOffset");
...
#pragma warning restore 0618
        ...
        void LateUpdateResetMaxDisplacementFromShape() => _maxHorizDispFromShape = _maxVertDispFromShape = _maxVertDispFromWaves = 0f;
        ...
        private static void OnReLoadScripts() => Instance = Helpers.FindAnyObjectByType<OceanRenderer>();
    ...
    public partial class OceanRenderer : IValidated
    {
        ...
        internal static void FixSetFeatureEnabled(SerializedObject oceanSO, string paramName, bool enabled) => oceanSO.FindProperty(paramName).boolValue = enabled;

...
namespace FischlWorks
{
    ...
    public class csHomebrewIK : MonoBehaviour
    {
        ...
        public float _LengthFromHeelToToes => lengthFromHeelToToes;

        public float _RaySphereRadius => raySphereRadius;

        public float _LeftFootProjectedAngle => leftFootProjectedAngle;

        public float _RightFootProjectedAngle => rightFootProjectedAngle;
        ...
        public float _AnkleHeightOffset => ankleHeightOffset;
        ...
        private float GetAnkleHeight() => raySphereRadius + _AnkleHeightOffset;
    ...
    {
        public string _BaseCondition => mBaseCondition;

        private string mBaseCondition = String.Empty;

        public ShowIfAttribute(string baseCondition) => mBaseCondition = baseCondition;
    }
    ...
    {
        public string _Text => mText;

        private string mText = String.Empty;

        public BigHeaderAttribute(string text) => mText = text;
    }
